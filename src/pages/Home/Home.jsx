...
const Home = () => {
  ...
  return (
    <>
      ...
      <button
        className="w-12 h-12 sm:w-16 sm:h-16 flex items-center justify-center rounded-full bg-black hover:bg-hovercolor cursor-pointer fixed right-5 bottom-5 sm:right-10 sm:bottom-10"
        onClick={() => {
          setOpenAddEditModal({
            isShown: true,
            type: 'add',
