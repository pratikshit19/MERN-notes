...
const AddEditNotes = ({noteData, type, getAllNotes, onClose, showToastMessage}) => {
    ...
    const handleAddNote = ()=> {
        ...
        if(!content){
            setError("Please enter the contents of your note");
            return;
        }
        setError("");
  ...
  return (
    <div className='relative'>
      ...
      <div className='flex flex-col gap-2'>
        ...
        <input 
        type='text'
        className='text-sm text-slate-950 outline-none bg-ghostwhite p-2 rounded-xl'
        ...
        <div className='flex flex-col gap-2 mt-4'>
            ...
            <textarea 
            type='text' 
            className='text-sm text-slate-950 outline-none bg-ghostwhite p-2 rounded-2xl' 
